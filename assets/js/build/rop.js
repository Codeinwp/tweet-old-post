...
var _rop_store = __webpack_require__(17);
...
var _logsTabPanel = __webpack_require__(60);
...
var _serviceUserTile = __webpack_require__(54);
...
module.exports = {
    ...
    computed: (0, _vuex.mapState)(['availableServices']),
    components: {
...
module.exports = {
    ...
    data: function data() {
        var default_network = '';
        if ((0, _keys2.default)(this.services)[0]) {
    ...
    computed: {
        states: (0, _vuex.mapState)(['displayTabs', 'page']),
