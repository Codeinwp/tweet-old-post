...
module.exports = {
	...
	computed: {
		...
		post_format: function post_format() {
			var activePostFormat = this.$store.state.activePostFormat;
	...
	methods: {
		...
		getShortnerCredentials: function getShortnerCredentials() {
