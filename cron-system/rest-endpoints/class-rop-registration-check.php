...
class Rop_Registration_Check {
	 ...
	 * @static
	 */
	private static $rop_base_tag = 'registration-check';
	...
	public function register_routes() {
		...
		register_rest_route(
			...
			array(
				...
				'args'                => array(
					'registration_key' => array( // This is expected in $_GET parameters and it's required
	...
	public function process_the_request( WP_REST_Request $request ) {
		$key = $request->get_param( 'registration_key' );
