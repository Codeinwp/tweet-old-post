	...
	public static function get_labels( $key = '' ) {
		$labels = array(
			...
			'settings'    => array(
				...
				'share_once_desc'             => __(
					'If all posts have been shared to your accounts, we should automatically restart the sharing.',
					'tweet-old-post'
				),
				'post_types_title'            => __( 'Post types', 'tweet-old-post' ),
				'post_types_taxonomy_limit' => sprintf( __( 'Upgrade to Pro to select more than two taxonomies %1$shere%2$s.', 'tweet-old-post' ), '<a href="https://revive.social/" target="_blank">', '</a>' ),
