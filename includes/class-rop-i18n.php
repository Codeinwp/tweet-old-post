	...
	public static function get_labels( $key = '' ) {
		$labels = array(
			...
			'settings'    => array(
				...
				'min_interval_desc'           => __( 'Minimum ime between shares (hour/hours), 0.4 can be used.', 'tweet-old-post' ),
				'min_days_title'              => __( 'Minimum Post Age', 'tweet-old-post' ),
				'min_days_desc'               => __( 'Minimum age of osts available for sharing, in days.', 'tweet-old-post' ),
				...
				'share_once_desc'             => __(
					'If all posts have been shared to your accounts, should we automatically restart the sharing?',
					'tweet-old-post'
				),
				...
				'instant_share_title'         => __( 'Enable Instant Sharing Feature', 'tweet-old-post' ),
			...
			'post_format' => array(
				...
				'image_desc'                        => __( 'Share as a standalone image? <a href="https://docs.revive.social/article/958-how-to-share-posts-as-image-posts-to-social-accounts" target="_blank">Learn more</a>.', 'tweet-old-post' ),
