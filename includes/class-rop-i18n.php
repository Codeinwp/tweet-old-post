	...
	public static function get_labels( $key = '' ) {
		$labels = array(
			'accounts'    => array(
				...
				'no_accounts_pro_upsell'  => sprintf( __( '<em>Unlock more great features! Checkout the Lite vs Pro table %1$shere%2$s.</em>', 'tweet-old-post' ), '<a class="text-bold" href="https://docs.revive.social/article/941-revive-old-post-free-vs-pro" target="_blank">', '</a>' ),
				...
				'activate_license'        => __( 'You need to activate your license key <a href="/wp-admin/options-general.php#tweet_old_post_pro_license" target="_blank" style="cursor: pointer">HERE</a> to unlock the Pro features of Revive Old Posts.', 'tweet-old-post' ),
			...
			'general'     => array(
				...
				'sharing_to_account'     => __( 'Sharing to Account(s)', 'tweet-old-post' ),
