	...
	public static function get_labels( $key = '' ) {
		$labels = array(
			...
			'queue'       => array(
				...
				'biz_only'                 => sprintf( __( 'You ca edit the posts from the queue only the Business version of the plugin. View more details %1$shere%2$s.', 'tweet-old-post' ), '<a href="' . self::UPSELL_LINK . '" target="_blank">', '</a>' ),
