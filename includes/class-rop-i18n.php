	...
	public static function get_labels( $key = '' ) {
		...
		$labels = array(
			...
			'general'     => array(
				...
				'tracking'                   => __( 'Help us improve by sending us anonymous usage data. This will help us understand how you use the plugin and what features are most important to you.', 'tweet-old-post' ),
				'global_settings_header'     => __( 'Global Settings', 'tweet-old-post' ),
