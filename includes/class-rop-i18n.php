	...
	public static function get_labels( $key = '' ) {
		$labels = array(
			...
			'queue'       => array(
				...
				'biz_only'                 => sprintf( __( 'You can edit the posts from the queue only the Business and Marketer versions of the plugin. View more details %1$shere%2$s.', 'tweet-old-post' ), '<a href="' . self::UPSELL_LINK . '" target="_blank">', '</a>' ),
