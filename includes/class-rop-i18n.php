	...
	public static function get_labels( $key = '' ) {
		$labels = array(
			...
			'settings'    => array(
				...
				'instant_share_desc'          => __( 'Allows you to share posts immediately on publish/update.', 'tweet-old-post' ),
				...
				'instant_share_future_scheduled_desc'   => __( 'Allows for the sharing of posts scheduled to publish at a future date by WordPress to your active social media accounts as soon as they change from "Scheduled" to "Published".', 'tweet-old-post' ),
				'instant_share_future_scheduled_yes'   	=> __( 'Yes', 'tweet-old-post' ),
				'instant_share_future_scheduled_upsell' => __( ' This feature is only available in the pro version. <a href="https://docs.revive.social/article/1194-share-scheduled-posts-to-social-media-on-publish-with-revive-old-posts" target="_blank">Learn more about this feature</a>.', 'tweet-old-post' ),
