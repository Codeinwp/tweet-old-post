...
You can try to disable any of the security plugins that you use in order to see if the issue persists or ask the hosting company to further investigate.',
			...
			'post_editor' => array(
				...
				'random_variation_info' => sprintf( __( 'Add share message variations to this post %1$sLearn More%2$s.', 'tweet-old-post' ), '<a class="text-bold" href="https://docs.revive.social/article/952-available-magic-tags-in-revive-old-posts" target="_blank">', '</a>' ),
