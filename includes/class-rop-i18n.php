	...
	public static function get_labels( $key = '' ) {
		$labels = array(
			...
			'settings'    => array(
				...
				'cron_type_notice'           => sprintf( __( '%1$sNOTE:%2$s This is a BETA Remote Cron feature to be used mainly if your %1$sposts aren\'t sharing%2$s. If the Remote Cron option is used, and you notice your posts are still not sharing, then please read the following guide for alternative solutions: %1$s%3$sLearn More%4$s%2$s.', 'tweet-old-post' ), '<strong>', '</strong>', '<a href="https://docs.revive.social/article/686-fix-revive-old-post-not-posting" target="_blank">', '</a>' ),
