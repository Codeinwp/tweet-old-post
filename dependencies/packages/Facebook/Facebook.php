 ...
 *
 */
namespace ROP\Dependencies\Facebook;

use ROP\Dependencies\Facebook\Authentication\AccessToken;
use ROP\Dependencies\Facebook\Authentication\OAuth2Client;
use ROP\Dependencies\Facebook\FileUpload\FacebookFile;
use ROP\Dependencies\Facebook\FileUpload\FacebookResumableUploader;
use ROP\Dependencies\Facebook\FileUpload\FacebookTransferChunk;
use ROP\Dependencies\Facebook\FileUpload\FacebookVideo;
use ROP\Dependencies\Facebook\GraphNodes\GraphEdge;
use ROP\Dependencies\Facebook\Url\UrlDetectionInterface;
use ROP\Dependencies\Facebook\Url\FacebookUrlDetectionHandler;
use ROP\Dependencies\Facebook\PseudoRandomString\PseudoRandomStringGeneratorFactory;
use ROP\Dependencies\Facebook\PseudoRandomString\PseudoRandomStringGeneratorInterface;
use ROP\Dependencies\Facebook\HttpClients\HttpClientsFactory;
use ROP\Dependencies\Facebook\PersistentData\PersistentDataFactory;
use ROP\Dependencies\Facebook\PersistentData\PersistentDataInterface;
use ROP\Dependencies\Facebook\Helpers\FacebookCanvasHelper;
use ROP\Dependencies\Facebook\Helpers\FacebookJavaScriptHelper;
use ROP\Dependencies\Facebook\Helpers\FacebookPageTabHelper;
use ROP\Dependencies\Facebook\Helpers\FacebookRedirectLoginHelper;
use ROP\Dependencies\Facebook\Exceptions\FacebookSDKException;
...
class Facebook
{
    ...
    public function setDefaultAccessToken($accessToken)
    {
        ...
        throw new \InvalidArgumentException('The default access token must be of type "string" or ROP\Dependencies\Facebook\AccessToken');
    }
