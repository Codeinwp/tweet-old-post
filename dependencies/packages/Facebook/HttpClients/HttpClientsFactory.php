 ...
 *
 */
namespace ROP\Dependencies\Facebook\HttpClients;
...
class HttpClientsFactory
{
     ...
     * @throws InvalidArgumentException If the http client handler isn't "curl", "stream", "guzzle", or an instance of ROP\Dependencies\Facebook\HttpClients\FacebookHttpClientInterface.
     *
    ...
    public static function createHttpClient($handler)
    {
        ...
        throw new InvalidArgumentException('The http client handler must be set to "curl", "stream", "guzzle", be an instance of GuzzleHttp\Client or an instance of ROP\Dependencies\Facebook\HttpClients\FacebookHttpClientInterface');
    }
