 ...
 *
 */
namespace ROP\Dependencies\Facebook\PseudoRandomString;
...
class PseudoRandomStringGeneratorFactory
{
     ...
     *
     * @throws InvalidArgumentException If the pseudo random string generator must be set to "random_bytes", "mcrypt", "openssl", or "urandom", or be an instance of ROP\Dependencies\Facebook\PseudoRandomString\PseudoRandomStringGeneratorInterface.
     *
    ...
    public static function createPseudoRandomStringGenerator($generator)
    {
        ...
        throw new InvalidArgumentException('The pseudo random string generator must be set to "random_bytes", "mcrypt", "openssl", or "urandom", or be an instance of ROP\Dependencies\Facebook\PseudoRandomString\PseudoRandomStringGeneratorInterface');
    }
