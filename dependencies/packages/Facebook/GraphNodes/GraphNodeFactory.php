 ...
 *
 */
namespace ROP\Dependencies\Facebook\GraphNodes;
...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = '\ROP\Dependencies\Facebook\GraphNodes\GraphNode';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = '\ROP\Dependencies\Facebook\GraphNodes\GraphEdge';

    /**
     * @const string The graph object prefix.
     */
    const BASE_GRAPH_OBJECT_PREFIX = '\ROP\Dependencies\Facebook\GraphNodes\\';
