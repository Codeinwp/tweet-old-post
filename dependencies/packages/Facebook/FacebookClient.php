...
use ROP\Dependencies\Facebook\HttpClients\FacebookHttpClientInterface;
use ROP\Dependencies\Facebook\HttpClients\FacebookCurlHttpClient;
use ROP\Dependencies\Facebook\HttpClients\FacebookStreamHttpClient;
...
class FacebookClient
{
    ...
    {
        if (get_class($request) === 'ROP\Dependencies\Facebook\FacebookRequest') {
