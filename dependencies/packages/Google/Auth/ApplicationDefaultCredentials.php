...
namespace ROP\Dependencies\Google\Auth;

use DomainException;
use ROP\Dependencies\Google\Auth\Credentials\AppIdentityCredentials;
use ROP\Dependencies\Google\Auth\Credentials\GCECredentials;
use ROP\Dependencies\Google\Auth\Credentials\ServiceAccountCredentials;
...
use ROP\Dependencies\Google\Auth\Subscriber\AuthTokenSubscriber;
 ...
 *
 * ```
 * use ROP\Dependencies\Google\Auth\ApplicationDefaultCredentials;
 * use GuzzleHttp\Client;
