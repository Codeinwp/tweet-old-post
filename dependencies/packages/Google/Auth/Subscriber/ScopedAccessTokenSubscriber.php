...
use ROP\Dependencies\Google\Auth\CacheTrait;
...
class ScopedAccessTokenSubscriber implements SubscriberInterface
{
     ...
     * use ROP\Dependencies\Google\Auth\Subscriber\ScopedAccessTokenSubscriber;
     ...
     *     $scope,
     *     ['prefix' => 'ROP\Dependencies\Google\Auth\ScopedAccessToken::'],
     *     $cache = new Memcache()
     * );
     *
     * $client = new Client([
