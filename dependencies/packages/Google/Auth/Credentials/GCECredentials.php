...
namespace ROP\Dependencies\Google\Auth\Credentials;

use ROP\Dependencies\Google\Auth\CredentialsLoader;
use ROP\Dependencies\Google\Auth\GetQuotaProjectInterface;
use ROP\Dependencies\Google\Auth\HttpHandler\HttpClientCache;
use ROP\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use ROP\Dependencies\Google\Auth\Iam;
use ROP\Dependencies\Google\Auth\ProjectIdProviderInterface;
use ROP\Dependencies\Google\Auth\SignBlobInterface;
 ...
 *
 *   use ROP\Dependencies\Google\Auth\Credentials\GCECredentials;
 *   use ROP\Dependencies\Google\Auth\Middleware\AuthTokenMiddleware;
