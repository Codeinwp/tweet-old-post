    ...
    UpdateMetadataInterface
{
     ...
     *     `ROP\Dependencies\Google\Auth\SignBlobInterface`.
     */
     ...
     * @return string|null
     * @throws \RuntimeException If the fetcher does not implement
     *     `ROP\Dependencies\Google\Auth\ProvidesProjectIdInterface`.
     */
     ...
     * @throws \RuntimeException If the fetcher does not implement
     *     `ROP\Dependencies\Google\Auth\UpdateMetadataInterface`.
     */
