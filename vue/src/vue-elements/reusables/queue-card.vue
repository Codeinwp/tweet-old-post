<template>
    <div class="card">
        <div class="columns">
            <div class="column col-8">
                <div class="columns">
                    ...
                    <div class="column col-4">
                        <button class="btn btn-sm btn-primary" @click="toggleEditState" v-if="!edit"
                                :disabled=" ! enabled">
                        ...
                        <button class="btn btn-sm btn-warning" @click="cancelChanges" v-if="edit"
                                :disabled=" ! enabled">
            ...
            <div class="column col-4" v-if="!edit">
