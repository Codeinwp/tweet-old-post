            ...
            <div class="column header-logo vertical-align" v-if="is_preloading_over > 0">
                <div>
                    ...
                    <h1 class="plugin-title d-inline-block">Revive Old Posts</h1><span class="powered d-inline-block"> {{labels.by}} <a
                        href="https://revive.social" target="_blank"><b>Revive.Social</b></a> <a href="https://www.youtube.com/watch?v=SY4jCBiFlgU&list=PLAsG7vAH40Q512C8d_0lBpVZusUQqUxuH" target="_blank" id="rop_vid_tuts"><span>START HERE <i class="fa fa-play-circle" aria-hidden="true"></i></span></a></span>
